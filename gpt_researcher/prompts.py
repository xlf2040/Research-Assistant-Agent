...
IMPORTANT: The "server" field MUST be in Chinese (中文), matching the language of the user's query. The "agent_role_prompt" field MUST also be in Chinese. Do NOT include emoji in any field.
...
{
    "server": "金融分析员",
    "agent_role_prompt": "您是一位经验丰富的金融分析AI助手。您的主要目标是基于提供的数据和趋势，撰写全面、敏锐、客观且有条理的金融报告。"
}
task: "could reselling sneakers become profitable?"
response:
{
    "server": "商业分析师",
    "agent_role_prompt": "您是一位经验丰富的AI商业分析助手。您的主要目标是基于商业数据、市场趋势和战略分析，撰写全面、深刻、客观且系统化的商业报告。"
}
task: "what are the most interesting sites in Tel Aviv?"
response:
{
    "server": "旅游顾问",
    "agent_role_prompt": "您是一位周游世界的AI旅游指南助手。您的主要目的是撰写引人入胜、深刻、客观且结构良好的旅游报告，涵盖目的地历史、景点和文化见解。"
}
"""
