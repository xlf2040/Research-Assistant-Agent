...
def get_formatted_logger():
    ...
    if not logger.handlers:
        # Create a handler with UTF-8 stream to avoid GBK encoding errors on Windows
        import io
        utf8_stream = io.TextIOWrapper(sys.stderr.buffer, encoding='utf-8', errors='replace') if hasattr(sys.stderr, 'buffer') else sys.stderr
