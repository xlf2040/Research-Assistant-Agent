...
const Accordion: React.FC<AccordionProps> = ({ logs }) => {
  ...
  return (
    <div id="accordion-collapse" data-accordion="collapse" className="mt-4 bg-white rounded-lg border border-gray-200">
      {processedLogs.map((log, index) => (
        <div key={index}>
          <h2 id={`accordion-collapse-heading-${index}`}>
            <button
              type="button"
              className="flex items-center w-full p-5 font-medium text-gray-800 rounded-t-xl gap-3 hover:bg-gray-50"
          ...
          >
            <div className="p-5 border border-b-0 border-gray-200 bg-gray-50 text-gray-800">
