  ...
  return (
    ...
    >
      ...
      <div 
        ...
        data-panel="research"
        className={`w-full ${isCopilotVisible ? '' : 'lg:w-full'} h-full overflow-hidden flex flex-col bg-gray-900/40 rounded-lg border border-gray-800/50 shadow-lg ${!resizingActive ? 'transition-width duration-300' : ''}`}
      ...
      {isCopilotVisible && (
        <div 
          ref={chatPanelRef}
          data-panel="chat"
          className={`w-full h-1/2 lg:h-full overflow-hidden flex flex-col bg-gray-900/40 rounded-lg border border-gray-800/50 shadow-lg ${!resizingActive ? 'transition-width duration-300' : ''} ${
