...
const CopilotPanel: React.FC<CopilotPanelProps> = ({
  ...
  return (
    <>
      {/* Panel Header */}
      <div className="flex justify-between items-center px-2 py-3 border-b border-gray-200 bg-white/90">
        {/* Left side */}
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center">
            ...
            <span className="text-xs text-gray-500">{loading ? '研究中' : isProcessingChat ? '思考中' : '在线'}</span>
          </div>
          ...
          {setIsCopilotVisible && (
            <button 
              ...
              className="flex items-center justify-center w-7 h-7 rounded-md hover:bg-gray-100 text-gray-400 hover:text-gray-600 transition-colors border border-transparent hover:border-gray-300"
      ...
      <div 
        ...
        className="flex-1 overflow-y-auto py-2 px-2 custom-scrollbar bg-gray-50"
      >
        ...
        <div className="mb-4">
          <div className="p-3 bg-gray-50 rounded-md border border-gray-200 shadow-sm">
            <div className="flex items-start gap-3">
              <div className="w-7 h-7 rounded-md bg-teal-50 flex items-center justify-center flex-shrink-0 text-teal-600 border border-teal-200">
                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
              ...
              <div className="text-gray-600 text-sm">
                {loading ? (
                  <p>正在为您研究...完成后我会分析结果。</p>
                ) : (
                  <p>我已分析完所有研究结果，可以回答相关问题。有什么可以帮您？</p>
                )}
              </div>
            </div>
          </div>
      ...
      {/* Chat Input */}
      <div className="py-3 px-2 border-t border-gray-200 bg-white/90">
        {!isStopped && (
          <ChatInput
        ...
        {isStopped && (
          <div className="text-center p-2 text-gray-500 bg-gray-50 rounded-md border border-gray-200 text-sm">
            研究已停止。开始新的研究以继续对话。
          </div>
        )}
      </div>
