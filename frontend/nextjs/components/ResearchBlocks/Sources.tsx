...
export default function Sources({
          ...
          {sources.map((source) => {
            ...
            return (
              <a 
                ...
                className="inline-flex items-center gap-1.5 px-2 py-1 text-xs bg-gray-100 text-gray-600 hover:text-teal-700 hover:bg-gray-200 rounded border border-gray-200 transition-colors"
                title={source.name}
              >
  ...
  return (
    <div className="container h-auto w-full shrink-0 rounded-lg border border-solid border-gray-200 bg-white shadow-sm p-5">
      <div className="flex items-start gap-4 pb-3 lg:pb-3.5">
        <img src="/img/browser.svg" alt="sources" width={24} height={24} />
        <h3 className="text-base font-bold uppercase leading-[152.5%] text-gray-800">
          {sources.length} 个来源{" "}
        </h3>
      </div>
