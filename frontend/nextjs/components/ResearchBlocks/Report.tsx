...
export default function Report({ answer, researchId }: { answer: string, researchId?: string }) {
    ...
    return (
      <div className="container flex h-auto w-full shrink-0 gap-4 bg-white shadow-sm rounded-lg border border-solid border-gray-200 p-5">
        <div className="w-full">
          <div className="flex items-center justify-between pb-3">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-sm font-medium text-teal-700">研究报告</h3>
            </div>
            {answer && (
              <div className="flex items-center gap-3">
                <button
          ...
          <div className="flex flex-wrap content-center items-center gap-[15px] pl-5 pr-5">
            <div className="w-full whitespace-pre-wrap text-base font-light leading-[152.5%] text-gray-800 log-message">
              {answer ? (
                <div className="markdown-content max-w-none" dangerouslySetInnerHTML={{ __html: htmlContent }} />
              ) : (
