...
const ChatInput: FC<TChatInputProps> = ({
  ...
  const placeholder = "关于这份报告有任何问题吗？";
  ...
  return (
    <div className="relative">
      ...
      <form
        className="mx-auto flex pt-2 pb-2 w-full items-center justify-between rounded-lg border border-gray-700/50 bg-gray-900/90 px-3 shadow-md relative overflow-hidden z-10"
        onSubmit={(e) => {
          e.preventDefault();
          if (!disabled && promptValue.trim()) {
            handleSubmit(promptValue);
