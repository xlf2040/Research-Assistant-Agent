...
const InputArea: FC<TInputAreaProps> = ({
  ...
  const placeholder = "请输入您的研究主题、问题或感兴趣的领域...";
  ...
  return (
    <div className="relative">
      ...
      <form
        className="mx-auto flex pt-2 pb-2 w-full items-center justify-between rounded-xl border border-gray-700/50 bg-gray-900/90 px-3 shadow-md relative overflow-hidden z-10"
        onSubmit={(e) => {
          e.preventDefault();
          if (reset) reset();
          handleSubmit(promptValue);
      ...
      >
        ...
        <div className="absolute -inset-1 bg-gradient-to-r from-teal-400/4 via-indigo-400/4 to-purple-400/4 blur-xl opacity-25 pointer-events-none"></div>
