...
const AccessReport: React.FC<AccessReportProps> = ({ accessData, chatBoxSettings, report, onShareClick }) => {
  ...
  return (
    <div className="container rounded-lg border border-solid border-gray-200 bg-white shadow-sm p-5 my-5">
      <div className="flex flex-col items-center">
        <h3 className="text-lg font-bold mb-4 text-gray-800">获取研究报告</h3>
