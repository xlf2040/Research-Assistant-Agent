    ...
    <main className="flex min-h-screen flex-col">
      ...
      {showScrollButton && showResult && (
        <button
          ...
          className="fixed bottom-8 right-8 flex items-center justify-center w-12 h-12 text-white bg-gradient-to-br from-teal-500 to-teal-600 rounded-full hover:from-teal-600 hover:to-teal-700 transform hover:scale-105 transition-all duration-200 shadow-lg z-50 border border-teal-400/20"
        >
          <svg 
